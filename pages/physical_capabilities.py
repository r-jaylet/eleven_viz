...
from src.additional_viz import plot_player_load_vs_expression
from src.data_preprocessing import load_gps, load_physical_capabilities
    ...
    try:
        ...
        tab1, tab2, tab3, tab4 = st.tabs(
            [
                ...
                "Movement Analysis",
                "Training Load vs Expression Development",
                "Recent Results",
            ]
        )
        ...
        with tab1:
            ...
            with col1:
                ...
                st.markdown(
                    """This chart shows the number of recorded tests for each expression type. """
                )
            ...
            with col2:
                ...
                st.markdown(
                    """This chart compares the distribution of performance (benchmark percentiles) between the two expression types."""
                )
            ...
            st.markdown(
                """This graph visualizes the evolution of benchmark performance over time. The grey line represents the daily average benchmark percentile on each test date, while the blue line applies a 3-day rolling average."""
            )
        ...
        with tab3:
            ...
            fig_load_vs_expression = plot_player_load_vs_expression(
                df_gps, df_filtered
            )
